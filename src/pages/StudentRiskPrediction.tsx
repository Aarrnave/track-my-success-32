...
import { Search, AlertTriangle, TrendingUp, User, Calendar, MessageSquare } from "lucide-react";
            ...
            {filteredStudents.map((student) => (
              <div 
                ...
                className={`p-4 rounded-lg border cursor-pointer transition-all hover:shadow-md ${
                  selectedStudent?.id === student.id ? 'border-primary bg-primary/5' : 'border-border bg-card/50 hover:bg-card'
                }`}
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{student.rollNo} • {student.branch}</p>
                  </div>
            ...
            <div className="chart-container">
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">
                  Choose a student from the list to view detailed risk analysis
                </p>
              </div>
            </div>
          )}
